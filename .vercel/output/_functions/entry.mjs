...
var middlewareSecret = "a103997e-641c-4ca8-80f3-59c9da08c1d7";
//#endregion
...
var _page0 = () => import("./chunks/generic_oZ4voagd.mjs").then((n) => n.t);
var _page1 = () => import("./chunks/Index_SaZJeZhd.mjs");
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "a103997e-641c-4ca8-80f3-59c9da08c1d7") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
