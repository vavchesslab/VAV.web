...
import { A as originPathnameSymbol, C as ASTRO_ERROR_HEADER, D as REROUTABLE_STATUS_CODES, E as REDIRECT_STATUS_CODES, M as decodeKey, N as decryptString, O as clientAddressSymbol, P as generateCspDigest, S as isRoute500, T as DEFAULT_404_COMPONENT, _ as isAstroComponentFactory, a as chunkToString, c as isRenderTemplateResult, g as pushDirective, h as normalizeCspResourceEntry, i as renderComponent, j as responseSentSymbol$1, k as fetchStateSymbol, l as renderTemplate, m as isRenderInstruction, n as renderPage, o as createSlotValueFromString, r as renderJSX, s as renderSlotToString, w as ASTRO_GENERATOR, x as isRoute404, y as renderEndpoint } from "./chunks/server_BuAIcLXN.mjs";
...
var middlewareSecret = "6cede49d-3c87-4354-977c-c8d624cda657";
//#endregion
...
var _page0 = () => import("./chunks/generic_DZAM09MB.mjs").then((n) => n.t);
var _page1 = () => import("./chunks/Index_8AeY81nM.mjs");
...
var _manifest = deserializeManifest({"rootDir":"file:///F:/DISCO/BACKUP%202025/Escritorio/Freelance/Nachito%20AJEDREZ/Ajedrez%20Website/","cacheDir":"file:///F:/DISCO/BACKUP%202025/Escritorio/Freelance/Nachito%20AJEDREZ/Ajedrez%20Website/node_modules/.astro/","outDir":"file:///F:/DISCO/BACKUP%202025/Escritorio/Freelance/Nachito%20AJEDREZ/Ajedrez%20Website/dist/","srcDir":"file:///F:/DISCO/BACKUP%202025/Escritorio/Freelance/Nachito%20AJEDREZ/Ajedrez%20Website/src/","publicDir":"file:///F:/DISCO/BACKUP%202025/Escritorio/Freelance/Nachito%20AJEDREZ/Ajedrez%20Website/public/","buildClientDir":"file:///F:/DISCO/BACKUP%202025/Escritorio/Freelance/Nachito%20AJEDREZ/Ajedrez%20Website/dist/client/","buildServerDir":"file:///F:/DISCO/BACKUP%202025/Escritorio/Freelance/Nachito%20AJEDREZ/Ajedrez%20Website/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Index.b-vcNcHO.css"}],"routeData":{"route":"/Index","isIndex":false,"type":"page","pattern":"^\\/Index\\/?$","segments":[[{"content":"Index","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/Index.astro","pathname":"/Index","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"redirect","isIndex":false,"route":"/","pattern":"^\\/$","segments":[],"params":[],"component":"/","pathname":"/","prerender":false,"redirect":"/Index","redirectRoute":{"route":"/Index","isIndex":false,"type":"page","pattern":"^\\/Index\\/?$","segments":[[{"content":"Index","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/Index.astro","pathname":"/Index","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}},"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["F:/DISCO/BACKUP 2025/Escritorio/Freelance/Nachito AJEDREZ/Ajedrez Website/src/pages/Index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","F:/DISCO/BACKUP 2025/Escritorio/Freelance/Nachito AJEDREZ/Ajedrez Website/node_modules/@astrojs/react/dist/vnode-children.js":"chunks/vnode-children_B6vVcKTz.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/Index@_@astro":"chunks/Index_8AeY81nM.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_DZAM09MB.mjs","F:/DISCO/BACKUP 2025/Escritorio/Freelance/Nachito AJEDREZ/Ajedrez Website/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_BdyTh1k7.mjs","F:/DISCO/BACKUP 2025/Escritorio/Freelance/Nachito AJEDREZ/Ajedrez Website/src/components/Galeria.astro?astro&type=script&index=0&lang.ts":"_astro/Galeria.astro_astro_type_script_index_0_lang.BSbllr-z.js","F:/DISCO/BACKUP 2025/Escritorio/Freelance/Nachito AJEDREZ/Ajedrez Website/src/components/GoUp.astro?astro&type=script&index=0&lang.ts":"_astro/GoUp.astro_astro_type_script_index_0_lang.BNT0O7lw.js","F:/DISCO/BACKUP 2025/Escritorio/Freelance/Nachito AJEDREZ/Ajedrez Website/src/components/Index.astro?astro&type=script&index=0&lang.ts":"_astro/Index.astro_astro_type_script_index_0_lang.Cdp4pQV5.js","F:/DISCO/BACKUP 2025/Escritorio/Freelance/Nachito AJEDREZ/Ajedrez Website/src/components/Laboratorio.astro?astro&type=script&index=0&lang.ts":"_astro/Laboratorio.astro_astro_type_script_index_0_lang.C-ZU7enw.js","F:/DISCO/BACKUP 2025/Escritorio/Freelance/Nachito AJEDREZ/Ajedrez Website/src/components/Navbar.astro?astro&type=script&index=0&lang.ts":"_astro/Navbar.astro_astro_type_script_index_0_lang.bJSdT1ju.js","@astrojs/react/client.js":"_astro/client.zAjUtANL.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["F:/DISCO/BACKUP 2025/Escritorio/Freelance/Nachito AJEDREZ/Ajedrez Website/src/components/Galeria.astro?astro&type=script&index=0&lang.ts","var e=document.querySelector(`#galeria-album`),t=document.querySelectorAll(`[data-album]`);e?.addEventListener(`change`,()=>{t.forEach(t=>{t.hidden=t.dataset.album!==e.value})});var n=document.querySelector(`#galeria-lightbox`),r=document.querySelector(`#galeria-lightbox-image`),i=document.querySelector(`#galeria-lightbox-category`),a=document.querySelector(`#galeria-lightbox-title`),o=document.querySelector(`#galeria-lightbox-prev`),s=document.querySelector(`#galeria-lightbox-next`),c=document.querySelector(`#galeria-lightbox-thumbnails`),l=document.querySelector(`#galeria-lightbox-position`),u=document.querySelector(`.galeria__lightbox-close`),d=document.querySelectorAll(`[data-lightbox-src]`),f=[],p=0;n&&document.body.append(n);var m=()=>{c&&c.replaceChildren(...f.map((e,t)=>{let n=document.createElement(`button`);n.type=`button`,n.className=`galeria__lightbox-thumbnail`,n.setAttribute(`aria-label`,`Ver ${e.dataset.lightboxTitle||`imagen`} ${t+1}`),n.addEventListener(`click`,()=>h(t));let r=document.createElement(`img`);return r.src=e.dataset.lightboxSrc||``,r.alt=e.dataset.lightboxAlt||``,n.append(r),n}))},h=e=>{if(!r||f.length===0)return;p=(e+f.length)%f.length;let t=f[p];r.src=t.dataset.lightboxSrc||``,r.alt=t.dataset.lightboxAlt||``,i&&(i.textContent=t.dataset.lightboxCategory||``),a&&(a.textContent=t.dataset.lightboxTitle||``),l&&(l.textContent=`Imagen ${p+1} de ${f.length}`),c?.querySelectorAll(`.galeria__lightbox-thumbnail`).forEach((e,t)=>{e.classList.toggle(`is-active`,t===p),t===p?e.setAttribute(`aria-current`,`true`):e.removeAttribute(`aria-current`)})},g=()=>{n&&r&&(n.hidden=!0,r.removeAttribute(`src`),document.body.style.overflow=``)};d.forEach(e=>{e.addEventListener(`click`,()=>{if(!n||!r)return;let t=e.closest(`[data-album]`);f=Array.from(t?.querySelectorAll(`[data-lightbox-src]`)||[]),p=f.indexOf(e),m(),h(p),n.hidden=!1,document.body.style.overflow=`hidden`})}),o?.addEventListener(`click`,()=>h(p-1)),s?.addEventListener(`click`,()=>h(p+1)),u?.addEventListener(`click`,g),n?.addEventListener(`click`,e=>{let t=e.target;t instanceof Element&&!t.closest(`.galeria__lightbox-image, .galeria__lightbox-arrow, .galeria__lightbox-thumbnail, .galeria__lightbox-close`)&&g()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&n&&!n.hidden&&g(),e.key===`ArrowLeft`&&n&&!n.hidden&&h(p-1),e.key===`ArrowRight`&&n&&!n.hidden&&h(p+1)});"],["F:/DISCO/BACKUP 2025/Escritorio/Freelance/Nachito AJEDREZ/Ajedrez Website/src/components/GoUp.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`go-up-button`),t=()=>{e&&(window.scrollY>300?e.classList.add(`is-visible`):e.classList.remove(`is-visible`))};window.addEventListener(`scroll`,t,{passive:!0}),t(),e?.addEventListener(`click`,()=>{window.scrollTo({top:0,behavior:`smooth`})});"],["F:/DISCO/BACKUP 2025/Escritorio/Freelance/Nachito AJEDREZ/Ajedrez Website/src/components/Navbar.astro?astro&type=script&index=0&lang.ts","var e=document.querySelectorAll(`.version-two-nav-link[data-nav]`),t=document.querySelectorAll(`section[id]`),n=document.querySelector(`.nav-actions`),r=document.querySelector(`.nav-active-indicator`),i=!1,a,o=t=>{let i;if(e.forEach(e=>{e.getAttribute(`data-nav`)===t?(e.classList.add(`is-active`),i=e):e.classList.remove(`is-active`)}),i&&n&&r){let e=n.getBoundingClientRect(),t=i.getBoundingClientRect();r.style.width=`${t.width}px`,r.style.transform=`translateX(${t.left-e.left}px)`}};e.forEach(e=>{e.addEventListener(`click`,t=>{let n=e.getAttribute(`data-nav`);if(n){if(i=!0,clearTimeout(a),n===`home`)t.preventDefault(),o(`home`),window.scrollTo({top:0,behavior:`smooth`});else{let e=document.getElementById(n);e&&(t.preventDefault(),o(n),e.scrollIntoView({behavior:`smooth`}))}a=window.setTimeout(()=>{i=!1},1e3)}})}),o(document.querySelector(`.version-two-nav-link.is-active`)?.dataset.nav||`home`),window.addEventListener(`resize`,()=>o(document.querySelector(`.version-two-nav-link.is-active`)?.dataset.nav||`home`));var s=new IntersectionObserver(e=>{i||e.forEach(e=>{if(e.isIntersecting){let t=e.target.getAttribute(`id`);t&&[`home`,`laboratorio`,`galeria`,`partidas`].includes(t)&&o(t)}})},{root:null,rootMargin:`-30% 0px -40% 0px`,threshold:0});t.forEach(e=>{let t=e.getAttribute(`id`);t&&[`home`,`laboratorio`,`galeria`,`partidas`].includes(t)&&s.observe(e)});"]],"assets":["/alfil.glb","/caballo.glb","/favicon.ico","/favicon.svg","/peon.glb","/reina.glb","/resultadofinal.glb","/rey.glb","/tablero.glb","/torre.glb","/torre.gltf","/VAVLogo_Dark.webm","/vav_bk.json","/vav_wh.json","/_astro/client.zAjUtANL.js","/_astro/Index.astro_astro_type_script_index_0_lang.Cdp4pQV5.js","/_astro/Laboratorio.astro_astro_type_script_index_0_lang.C-ZU7enw.js","/_astro/rolldown-runtime.CbXtAM7H.js","/_astro/Index.b-vcNcHO.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"lg2AkSdmTL08Zkx/JvHe7bIt7GmOHsOHnBMdcoiwj/A=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			OS: "Windows_NT",
			Path: "F:\\DISCO\\BACKUP 2025\\Escritorio\\Freelance\\Nachito AJEDREZ\\Ajedrez Website\\node_modules\\.bin;F:\\DISCO\\BACKUP 2025\\Escritorio\\Freelance\\Nachito AJEDREZ\\node_modules\\.bin;F:\\DISCO\\BACKUP 2025\\Escritorio\\Freelance\\node_modules\\.bin;F:\\DISCO\\BACKUP 2025\\Escritorio\\node_modules\\.bin;F:\\DISCO\\BACKUP 2025\\node_modules\\.bin;F:\\DISCO\\node_modules\\.bin;F:\\node_modules\\.bin;D:\\Program Files\\nodejs\\node_modules\\npm\\node_modules\\@npmcli\\run-script\\lib\\node-gyp-bin;c:\\Users\\Manuel\\AppData\\Roaming\\Code\\User\\globalStorage\\github.copilot-chat\\debugCommand;c:\\Users\\Manuel\\AppData\\Roaming\\Code\\User\\globalStorage\\github.copilot-chat\\copilotCli;C:\\Program Files (x86)\\NVIDIA Corporation\\PhysX\\Common;C:\\Windows\\System32;C:\\Windows;C:\\Windows\\System32\\wbem;C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\;C:\\Windows\\System32\\OpenSSH\\;C:\\Program Files\\dotnet\\;F:\\Program Files\\Git\\cmd;D:\\Program Files\\nodejs\\;C:\\WINDOWS\\system32\\config\\systemprofile\\AppData\\Local\\Muse Hub\\lib;C:\\Program Files\\Git\\cmd;C:\\Users\\Manuel\\AppData\\Local\\Microsoft\\WindowsApps;D:\\Users\\Manuel\\AppData\\Local\\Programs\\Microsoft VS Code\\bin;C:\\Users\\Manuel\\AppData\\Roaming\\npm;C:\\Users\\Manuel\\AppData\\Local\\Microsoft\\WinGet\\Packages\\OpenJS.NodeJS.22_Microsoft.Winget.Source_8wekyb3d8bbwe\\node-v22.22.3-win-x64;C:\\Users\\Manuel\\AppData\\Local\\Muse Hub\\lib"
		})?.PROD) return {
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "6cede49d-3c87-4354-977c-c8d624cda657") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
