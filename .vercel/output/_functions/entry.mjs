...
var middlewareSecret = "c8777a80-a600-4192-9991-ce1bd484926e";
//#endregion
...
var _page0 = () => import("./chunks/generic_Bsu4PNYk.mjs").then((n) => n.t);
var _page1 = () => import("./chunks/Index_f3KBSwEQ.mjs");
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "c8777a80-a600-4192-9991-ce1bd484926e") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
